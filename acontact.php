...
<?php
  ...
  // write query data
  $query = "SELECT * FROM admin_contact WHERE ccontact_id = 1";
...
<body  >
    ...
    <div class="col-12  p-0 d-lg-flex" style="background-image: linear-gradient(to bottom, #0575E6 , #021B79);">
        ...
        <div class="  justify-content-start  col-lg-3 col-sm-12 col-md-3 p-0 d-inline " style="background: linear-gradient(45deg blue black);" > 
        <nav class="navbar navbar-expand-lg navbar-light p-0 ">
            ...
            <div class="collapse navbar-collapse " id="navbarText">
              <ul class=" d-block  p-0" style="width: 100%; font-size: 1.2rem;" >
                ...
                <a href="#"><div class=" sidover pl-5  text-dark">Contact</div></a>
    ...
    <!-- body -->
        <main class="col-lg-9 border border-white d-lg-inline d-sm-block  bg-white p-0 " style="height: 91vh; border-width: 0rem ;">
            <div class="demoFont justify-content-center d-flex p-3" > Contact List</div>
                ...
                <tbody>
                  <?php 
                    ...
                    while ($data = $result->fetch_object())  {
                      ...
                      echo "<td>";
                        echo"<a href='delete.php?deleteCId=$data->id' class='btn btn-danger btn-sm'>Delete</a>";
                      echo"</td>";
                      echo "</tr>";
                    }
