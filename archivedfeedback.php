...
$username = $_SESSION['name'];
  ...
  // mysql connectivity
    ...
    // write query data
    $query = "SELECT * FROM admin_feedback WHERE feedback_id = 0";
...
<body  >
    ...
    <div class="col-12  p-0 d-lg-flex" style="background-image: linear-gradient(to bottom, #0575E6 , #021B79);">
        ...
        <nav class="navbar navbar-expand-lg navbar-light p-0 ">
            ...
            <div class="collapse navbar-collapse " id="navbarText">
              <ul class=" d-block  p-0" style="width: 100%; font-size: 1.2rem;" >
                ...
                <a href="#"><div class=" sidover pl-5 ">Feedback</div></a>
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="collapse multi-collapse" id="multiCollapseExample1" style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;">
                            ...
                            <a href="#"><div class=" sidover pl-5 ">Archived Feedback</div></a>
                          </div>
                        </div>
        ...
        <!-- body -->
        <main class="col-lg-9 border border-white d-lg-inline d-sm-block   p-0 " style="height: 91vh; ">
            <div class="demoFont justify-content-center d-flex p-3"> Archived Feedback</div>
                ...
                <tbody>
                  <?php 
                    ...
                    while ($data = $result->fetch_object())  {
                      ...
                      echo "<td>";
                        echo"<a href='delete.php?RecFId=$data->id' class='btn btn-success btn-sm mr-2'>Recover</a>";
                        echo"<a href='delete.php?HarddeleteFId=$data->id' class='btn btn-danger btn-sm'>Delete</a>";
                      echo"</td>";
                      echo "</tr>";
                    }
