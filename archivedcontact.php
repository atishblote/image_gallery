...
<body  >
               ...
               <ul class="mb-0 d-flex align-items-center" style="list-style-type: none;">
                    ...
                    <li class="nav-item ">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item" href="contact.php" data-toggle="modal" data-target="#logoutModal">
    ...
    <div class="col-12  p-0 d-lg-flex" style="background-image: linear-gradient(to bottom, #0575E6 , #021B79);">
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="collapse multi-collapse" id="multiCollapseExample1" style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;">
                            ...
                            <a href="#"><div class=" sidover pl-5 ">Archived Contact</div></a>
        ...
        <!-- body -->
        <main class="col-lg-9 border border-white d-lg-inline d-sm-block  bg-white p-0 " style="height: 90vh; border-width: 0rem ;">
            <div class="demoFont justify-content-center d-flex p-3" >Arcived Contact</div>
                ...
                <tbody>
                  <?php 
                    ...
                    while ($data = $result->fetch_object())  {
                      ...
                      echo "<td> $data->cmobile  </td>";
                     
                      echo "<td>";
                        echo"<a href='delete.php?RecCId=$data->id' class='btn btn-success btn-sm mr-2'>Recover</a>";
                        echo"<a href='delete.php?HarddeleteCId=$data->id' class='btn btn-danger btn-sm'>Delete</a>";
                      echo"</td>";
                      echo "</tr>";
                    }
